...
<body>
	<!-- 头部 -->
	<table width="1222" border="0" align="center" cellpadding="0" cellspacing="0" <%-- background="${basePath}images/sysmanage/xingzheng.png" --%> class="top">
		<tr>
			<td width="26" height="106">&nbsp;</td>
			<td width="416" height="110" align="left" valign="middle">
			
				<%-- <img class="zxx_test_png" src="${basePath}images/home/ind03.png" width="470" height="90" alt="" /> --%>
				<img class="zxx_test_png" src="${basePath}images/home/ind03.png" width="280" height="40" alt="" />
			</td>
			<td width="135">&nbsp;</td>
			<td width="418">
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
                ...
                <li><a href="javascript:void(0);">党建管理</a></li>
                <li><a href="${basePath}sysmanage/home_frame.action">系统管理</a></li>
			</ul>
		</div>
	</div>
</body>
