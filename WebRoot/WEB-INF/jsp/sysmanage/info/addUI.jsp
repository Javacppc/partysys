...
<form id="form" name="form" action="${basePath }sysmanage/info_add.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td colspan="3"><s:textarea name="info.remark" cols="90" rows="3"/></td>
        </tr>
        <tr>
            ...
            <td>
             	<s:date format="yyyy-MM-dd HH:mm" name="info.createTime"/>
